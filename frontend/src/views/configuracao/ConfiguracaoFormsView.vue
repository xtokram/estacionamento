    ...
    <div class="container col-6">
        ...
        <div class="row">
            <div class="col-md-12 text-start">
                ...
                <input type="text" :disabled="this.form === 'excluir' ? '' : disabled" class="form-control" placeholder="Valor por hora"
                    v-model="configuracao.valorHora">
            </div>
            <div class="col-md-12 text-start">
                <label class="form-label mt-3">Tempo para desconto *</label>
                <input type="text" :disabled="this.form === 'excluir' ? '' : disabled" class="form-control" placeholder="Valor em hora"
            ...
            <div class="col-md-12 text-start">
                ...
                <input type="text" :disabled="this.form === 'excluir' ? '' : disabled" class="form-control" placeholder="Valor por minuto"
                    v-model="configuracao.valorMinutoMulta">
            </div>
            <div class="col-md-12 text-start">
                <label class="form-label mt-3">Vagas para motos *</label>
                <input type="text" :disabled="this.form === 'excluir' ? '' : disabled" class="form-control" placeholder="Número de vagas"
                    v-model="configuracao.vagasMotos">
            </div>
            <div class="col-md-12 text-start">
         ...
         <div class="row mt-3">
            <div class="col-md-3 offset-md-6">
                <div class="d-grid gap-2">
                    <router-link type="button" class="btn btn-secondary" to="/configuracao/lista">Voltar
                    </router-link>
                </div>
            </div>
            <div class="col-md-3 ">
